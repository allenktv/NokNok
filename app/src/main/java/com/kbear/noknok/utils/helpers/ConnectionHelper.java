...
public final class ConnectionHelper {
    ...
    public void init(Context context) {
        getInstance().setConnectivityManager(
                (ConnectivityManager) context.getSystemService(NokNokApplication.CONNECTIVITY_SERVICE));
    }
    ...
    /**
     * Checks if connection is fast (greater than 1mbps)
     *
     * @param type,   WIFI or MOBILE
     * @param subType MOBILE type of connection
     * @return fast or not
     */
